...
- [/data](/data) contain [input_queries.txt](/data/input_queries.txt) having user queries. The output file [output.json](/data/output.json) is also generated here.
- [/embeddings](/embeddings) contain the Fasttext embeddings file for English [en_embeddings.p](/embeddings/en_embeddings.p).
